...
-- 그 결과를 OR price < 20000 조건과 결합합니다.
...
-- 그 결과에서 AND price >= 50000 조건이 적용됩니다.
...
-- 정답: 2
-- price * 0.9 > 30000과 stock <= 20가 OR로 먼저 계산되고, 
-- NOT 조건이 price < 10000을 부정하여 price >= 10000로 평가됩니다.
...
-- 문제 5
-- 재고가 10개 이하인 제품들을 대상으로, 20% 할인을 적용한 금액을 계산하여 제품명과 함께 조회하세요.
