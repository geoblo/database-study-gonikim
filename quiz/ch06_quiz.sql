...
-- 문제 3
-- 다음 중 CHECK 제약 조건이 설정된 컬럼에 대해 위배되는 입력값을 고르세요.
...
-- 문제 1
-- members 테이블에서 email 컬럼에 적용된 제약 조건으로 올바른 것은 무엇입니까?
...
-- 문제 2
-- member_profiles 테이블에서 member_id 컬럼의 역할은 무엇입니까?
...
-- 문제 3
-- books 테이블의 stock 컬럼에서 허용되지 않는 값은 무엇입니까?
...
-- 문제 5
-- library_staff 테이블의 salary 컬럼에 대해 CHECK 제약 조건으로 허용되지 않는 값은 무엇입니까?
...
-- 문제 8
-- member_profiles 테이블의 member_id 컬럼에 UNIQUE 제약 조건을 적용한 이유는 무엇입니까?
...
-- 문제 9
-- library_staff 테이블의 role 컬럼의 기본값은 무엇입니까?
