...
-- 성별 코드('M'/'F')나 우편번호, 국가 코드('KR'/'US')처럼 항상 길이가 정해져 있는 데이터에 사용하면, 
-- VARCHAR 보다 아주 약간의 이점을 가질 수 있음
...
INSERT INTO orders (id, name, price, quantity, created_at)
VALUES    
    (24, 'ㄴ자형 책상', 5387.75, 1, '2024-10-24 01:19:44');
